...
X = data.drop(columns=['label', 'src', 'fname', 'funcaddr'])
# X = data.drop(columns=['label', 'src', 'fname', 'keyimportapiinfo', 'netkeywords' , 'funcaddr', 'n_memcmp', 'n_net', 'n_API', 'out_degree']) 
y = data['label']
...
save_directory = 'F:/gadgets/TaintSource/res' 
